      ...
      <div class="card-body">
		<form action="quizsubmit.php" id="msform" method="get" name="form" >
			<fieldset>
				...
				<input type="button" name="next" value="Next" class=" btn btn-outline-primary btn-lg next-btn">
			</fieldset>

			<fieldset>
				<h3>2.Which of the following is crucial time while accessing data on the disk?</h3>
				...
				<input type="button" name="next" value="Next" class="next-btn">
			</fieldset>
			<fieldset>
				<h3>3.Unix Operating System is an __________.</h3>
			...
			<fieldset>
				<h3>4.Which of the following memory allocation scheme suffers from External fragmentation?</h3>
			...
			<fieldset>
				<h3>5.Information about a process is maintained in a _________. </h3>
			...
			<fieldset>
				<h3>6.Distributed OS works on the ________ principle.</h3>
			...
			<fieldset>
				<h3>7.The problem of fragmentation arises in ________.</h3>
			...
			<fieldset>
				<h3>8.The program is known as _________ which interacts with the inner part of called kernel.</h3>
			...
			<fieldset>
				<h3>9.Cryptography technique is used in ________. </h3>
			...
			<fieldset>
				<h3>10.Which of the following is not advantage of multiprogramming?</h3>
			...
			<fieldset>
				<h3>11.Which technique was introduced because a single job could not keep both the CPU and the I/O devices busy?</h3>
			...
			<fieldset>
				<h3>12.Inter process communication can be done through __________.</h3>
			...
			<fieldset>
				<h3>13.CPU performance is measured through ________.</h3>
			...
			<fieldset>
				<h3>14.PCB stands for _________.</h3>
			...
			<fieldset>
				<h3>15.Which of the following is contained in Process Control Block (PCB)?</h3>
			...
			<fieldset>
				<h3>16.Round robin scheduling is essentially the preemptive version of ________.</h3>
			...
			<fieldset>
				<h3>20.The solution to Critical Section Problem is : Mutual Exclusion, Progress and Bounded Waiting.</h3>
			...
			<fieldset>
				<h3>21.The number of processes completed per unit time is known as __________.</h3>
			...
			<fieldset>
				<h3>24.The mechanism that bring a page into memory only when it is needed is called</h3>
			...
			<fieldset>
				<h3>25.Which is not the state of the process ?</h3>
